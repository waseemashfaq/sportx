          ...
          <form class="forms-sample" id="addForm" method="post" action="#" role="form"  enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                ...
                <input class="form-control mb-4 mb-md-0" name="title" placeholder=" Enter title"  />
                  ...
                  <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                              <div class="card-body">
                                    ...
                                    <textarea class="form-control summernote" name="detail" id="" rows="10"  value="{{old('detail')}}"></textarea>
                              </div>
                        </div>
                  </div>
            </div>
